...
// Indexof zu Non ECMA-262 Standard-konformen Browsern hinzufügen
    if (!Array.prototype.indexOf) {
        Array.prototype.indexOf = function (searchElement /*, fromIndex */ ) {
            ...
            if (arguments.length > 0) {
                ...
                if (n != n) { // Verknüpfung für die Überprüfung, ob es NaN ist
                    n = 0;
    ...
    //Füge LastIndexof zu Non ECMA-262-Standard-konformen Browsern hinzu
...
// Das i18Next -Objekt für ** CommonJs ** exportieren.
    // Wenn wir nicht in CommonJS sind, füge "i18n" hinzu
    // globales Objekt oder JQuery.
    ...
    function _ajax(options) {
        ...
        var getXhr = function (callback) {
            //Verwenden das native XHR -Objekt, wenn der Browser es unterstützt.
            if (window.XMLHttpRequest) {
                return callback(null, new XMLHttpRequest());
            } else if (window.ActiveXObject) {
                // Überprüfen im Internet Explorer nach ActiveX -Versionen des XHR -Objekts.
                try {
            ...
            //Wenn keine XHR -Unterstützung gefunden wurde, gebe einen Fehler aus.
        ...
        var mergeHeaders = function () {
            ...
            // Durch die verbleibenden Header -Objekte iterieren und hinzufügen.
            ...
            //Rueckgabe des zusammengeführten Headers.
            return result;
        };
