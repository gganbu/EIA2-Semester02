namespace L08_2_Beach {
    ...
    function drawBoat(_position: Vector, _fillColor: string): void {
    ...
    function drawBird(_position: Vector, _fillColor: string): void {
        //bird
    ...
    function drawTree(_position: Vector, _fillColor: string): void {
    ...
    function drawTreeG(_position: Vector, _fillColor: string): void {
        //Tree
        crc2.beginPath();
    ...
    function drawTreeCoco(_position: Vector, _fillColor: string): void {
    ...
    function drawHuman(_position: Vector, _fillColor: string): void {
