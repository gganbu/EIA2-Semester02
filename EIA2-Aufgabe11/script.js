...
(function (Beach) {
    ...
    function handleLoad(_event) {
        ...
        for (let i = 0; i < cloudCount; i++) {
            ...
            let newCloud = new Beach.Cloud(new Beach.Vector(canvasRandomX, canvasRandomY), "#f7f7f7", 1000);
        ...
        for (let i = 0; i < boatCount; i++) {
            ...
            let newBoat = new Beach.Boat(new Beach.Vector(canvasRandomX, canvasRandomY), "#f7f7f7", 1000);
    ...
    function handleButton() {
        Beach.Moveable.forward = !Beach.Moveable.forward;
        Beach.Cloud.forward = !Beach.Cloud.forward;
        Beach.Boat.forward = !Beach.Boat.forward;
    }
    //Sky
